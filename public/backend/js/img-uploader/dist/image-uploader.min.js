...
(function ($) {
    $.fn.imageUploader = function (options) {
        let defaults = {
            ...
            label: "Drag & Drop gambar info disini atau klik disini",
        };
        let plugin = this;
        plugin.settings = {};
...
(function ($) {
    $.fn.imageUploaderCover = function (options) {
        let defaults = {
            preloaded: [],
            imagesInputName: "cover",
            preloadedInputName: "preloaded",
            label: "Drag & Drop satu gambar cover disini atau klik disini",
        };
        let plugin = this;
        plugin.settings = {};
        plugin.init = function () {
...
// Input Image Umum
(function ($) {
    $.fn.imageUploaderAll = function (options) {
        let defaults = {
            preloaded: [],
            imagesInputName: "gambar",
            preloadedInputName: "preloaded",
            label: "Drag & Drop satu gambar disini atau klik disini",
        };
        let plugin = this;
        plugin.settings = {};
        plugin.init = function () {
