...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Info Wisata</h1>
  </div>
  ...
  <div class="row">
    <div class="card-body col-md-6">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="judul" placeholder="Judul Info Wisata" value="{{ old('judul') }}">
      </div>
      <div class="form-group">
    ...
    <div class="row align-items-center justify-content-center mt-4">
      <div class="col-sm-3">
        <a href="{{ url('merchant/wisata') }}" class="btn btn-secondary">Kembali</a>
      </div>
      <div class="col-sm-3">
