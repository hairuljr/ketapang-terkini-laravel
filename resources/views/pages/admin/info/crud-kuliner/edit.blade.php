...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="card-body col-md-6">
      <form action="{{ route('info-kuliner.update', $item->id) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
      @csrf
  ...
  <div class="row align-items-center justify-content-center">
    <div class="col-sm-3 mb-2">
      <a href="{{ url('admin/info-kuliner') }}" class="btn btn-secondary mx-4">Kembali</a>
