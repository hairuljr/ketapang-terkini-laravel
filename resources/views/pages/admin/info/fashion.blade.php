...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('info-fashion.create') }}" class="btn btn-sm btn-primary shadow-sm">
        ...
        <table id="dataTable" class="table table-bordered table-hover" width="100%" cellspacing="0">
          ...
          <tbody id="galley">
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('info-fashion.edit', $item->id) }}" class="btn btn-info my-1">
                <i class="fa fa-pencil-alt"></i></a>
                <form action="{{ route('info-fashion.destroy', $item->id) }}" method="POST" class="d-inline">
                @csrf
                @method('delete')
