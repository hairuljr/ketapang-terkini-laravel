...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Info Jasa</h1>
  </div>
  ...
  <div class="row">
    <div class="card-body col-md-6">
      <form action="{{ route('info-jasa.update', $item->id) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
      @csrf
  ...
  <div class="row align-items-center justify-content-center">
    <div class="col-sm-3 mb-2">
      <a href="{{ url('admin/info-jasa') }}" class="btn btn-secondary mx-4">Kembali</a>
